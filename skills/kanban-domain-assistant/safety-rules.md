# Safety Rules for Minimal Kanban / Task Board Backend
...
- **Do not** change workflow or transition rules (e.g. `todo → doing → done`), column semantics, or task/column ordering behavior in a way that would break existing clients or data.
