# Safety Rules for Personal Finance Snapshot API
...
- **Do not** change transaction/category/snapshot semantics, validation rules, or amount/date handling in a way that would break existing clients or stored data.
