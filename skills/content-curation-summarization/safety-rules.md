# Safety Rules for Content Curation & Summarization Service
...
- **Do not** change article/summary/tag models or summarization response schemas in a way that would break existing clients or stored data.
