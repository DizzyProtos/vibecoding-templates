# Safety Rules for Micro-Journal Prompt Generator API
...
- **Do not** change prompt selection logic, preference semantics, or response schemas in a way that would break existing clients or integrations.
