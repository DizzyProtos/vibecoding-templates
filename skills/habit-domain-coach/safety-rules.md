# Safety Rules for AI-Powered Habit Tracker API
...
- **Do not** change habit/completion/streak semantics, date rules, or daily-summary behavior in a way that would break existing clients or stored data.
